...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if($result1){
    ...
    if($row1 && isset($row1["Email"]))
    {
      $errorMessage = "Email đã tồn tại. Vui lòng thử lại.";
    }
    else
    {
      $addTK = "INSERT INTO tbltaikhoan(Username,Password,Email,Lever) VALUES ('$username1','$password1','$email1','$lever')";
    ...
    $errorMessage = "Người dùng không tồn tại hoặc mật khẩu không được đặt.";
  }
}
?>
<!DOCTYPE html>
