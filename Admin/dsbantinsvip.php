...
$sql_bantin = "SELECT * from tbltindv INNER JOIN tbl_lbantin on tbltindv.Ltin_ID = tbl_lbantin.Ltin_ID INNER JOIN tbltaikhoan on tbltindv.Tk_ID = tbltaikhoan.Tk_ID WHERE tbltindv.Tttindv_ID = 2 AND tbltindv.Tin_svip = 0 ORDER BY Tin_time DESC";
                        ...
                        <?php foreach ($ds as $row1) : ?>
                          <tr>
                            ...
                            <td>
                                ...
                                <?php endif; ?>
                            <td>
                                <a href="./model/cf_editsvip.php?sid=<?php echo $row1['TinID']; ?>" type="button" class="btn mb-2 btn-primary fe fe-star"></a>
                            </td>
                          </tr>
                          <?php endforeach; ?>
                        </tbody>
