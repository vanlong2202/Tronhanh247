...
$sql_bantin = "SELECT * from tbltindv INNER JOIN tbl_lbantin on tbltindv.Ltin_ID = tbl_lbantin.Ltin_ID INNER JOIN tbltaikhoan on tbltindv.Tk_ID = tbltaikhoan.Tk_ID WHERE tbltindv.Tttindv_ID != 1 ORDER BY Tin_time DESC";
