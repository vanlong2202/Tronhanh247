<?php include_once('header.php') ?>
      <main role="main" class="main-content">
        <?php
            ...
            $sua_sql = "SELECT * FROM tblMenu WHERE MenuID = '$MenuID'";
          ...
          <div class="row justify-content-center">
            <div class="col-12">
              ...
              <div class="card shadow mb-4">
                    <form action="./model/cf_editMenu.php" method="post">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                <div class="form-group mb-3">
                                        <label for="MenuID">MenuID</label>
                                        <input type="text" id="MenuID" name="MenuID" class="form-control" readonly="" placeholder="" value="<?php echo $row['MenuID']; ?>">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="MenuName">Tên Menu</label>
                                        <input type="text" id="MenuName" name="MenuName" class="form-control" value="<?php echo $row['MenuName']; ?>">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="Levels" name="Levels" class="form-control" placeholder="" value="<?php echo $row['Levels']; ?>">
                                    </div>
                                    <div class="form-group mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="Link" name="Link" class="form-control" placeholder="" value="<?php echo $row['Link']; ?>">
                                    </div>
